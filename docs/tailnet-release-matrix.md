...
## v1.6.23 release exception

- **release authorization:** requesting operator explicitly approved v1.6.23 preparation and the physical-device gate exception on 2026-09-24 (UTC). publication follows operator merge of the release PR and successful release checks.
- **exception scope:** the unverified host, iOS/Android PWA, and recovery checks in this matrix are waived for v1.6.23 only. this is not standing approval for later releases.
