# Wolfpack documentation

Choose the audience and task that matches what you need. These links route to the canonical guides; this page does not replace them.

> **security and trust:** before enabling remote access, review the [canonical security and trust guidance](installation.md#security-and-trust).

## use Wolfpack

- [Install and verify Wolfpack](installation.md) — choose an install path and confirm the first working URL.
- [Create your first session](first-session.md) — open a project, start a session, and return to it later.
- [Set up phone, PWA, and notifications](phone-pwa-notifications.md) — choose the verified phone route and recover common mobile states.
- [Recover from common failures](troubleshooting.md) — find the canonical setup, service, broker, and remote-access checks.
